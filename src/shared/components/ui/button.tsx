...
const buttonVariants = cva(
  "flex items-center justify-center font-medium font-heading whitespace-nowrap text-sm leading-none! transition-all duration-300 gap-2 group relative cursor-pointer select-none",
  {
    variants: {
      variant: {
