...
const buttonVariants = cva(
  "group relative flex cursor-pointer select-none items-center justify-center gap-2 whitespace-nowrap font-heading font-medium text-sm leading-none! transition-all duration-300",
  {
    variants: {
      variant: {
      ...
      size: {
        base: "h-10 rounded-full px-5 text-sm",
